...
The zsh area SHALL configure Zinit-managed plugins and Starship prompt integration.

#### Scenario: Zsh starts with repository config
- **WHEN** a shell sources the repository `.zshrc`
- **THEN** it SHALL initialize Zinit, load Starship, and load the configured Zsh plugins
